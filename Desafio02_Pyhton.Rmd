...
# Verificar e instalar os pacotes se necessário
if (!py_available("pandas")) py_install("pandas")
if (!py_available("numpy")) py_install("numpy")
if (!py_available("matplotlib")) py_install("matplotlib") 
if (!py_available("seaborn")) py_install("seaborn")
```
...
def processar_dados():
    file_path = "flights.csv.zip"  # Caminho do arquivo de dados
    
    # VERIFICAÇÃO: Confirma que o arquivo existe antes de processar
    if not os.path.exists(file_path):
        raise FileNotFoundError("Arquivo flights.csv.zip não encontrado!")
